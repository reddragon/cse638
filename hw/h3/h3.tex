...
A B-Tree with $N$ elements has $\frac{N}{B}$ elements in nodes at height $h$ = 0, 
$\frac{N}{B^2}$ elements in nodes at height $h$ = 1, and more generally,
$\frac{N}{B^h}$ elements in nodes at height $h$. At each level, we scan through
the current nodes, ... TODO: Fill up
